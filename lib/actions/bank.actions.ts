...
export const getAccounts = async ({ userId }: getAccountsProps) => {
    try {
        ...
        return parseStringify({ data: accounts, totalBanks, totalCurrentBalance } as never);
    } catch (error) {
...
export const getInstitution = async ({
    ...
    try {
        ...
        return parseStringify(intitution as never);
    } catch (error) {
        console.error("An error occurred while getting the accounts:", error);
    }
};
...
export const getTransactions = async ({
    ...
    try {
        ...
        return parseStringify(transactions as never);
    } catch (error) {
        console.error("An error occurred while getting the accounts:", error);
    }
};